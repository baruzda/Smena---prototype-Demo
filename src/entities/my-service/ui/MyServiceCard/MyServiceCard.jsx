...
import { resolveMyServicePresentation } from "../../model/resolveMyServicePresentation.js";
import styles from "./MyServiceCard.module.css";

export function MyServiceCard({ booking }) {
  const { task } = booking;
  const presentation = resolveMyServicePresentation(booking);
